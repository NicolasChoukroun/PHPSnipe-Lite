...
if (!$user->is_logged ||  $user->id<=0)    	{echo '<script>window.top.location.href = "/login.php?error='. encrypt(_t("Security Credential Error Admin")). '";</script>';exit;}
if (!$user->is_admin )    {echo '<script>window.top.location.href = "/403.php";</script>';exit;}
