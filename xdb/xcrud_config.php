...
{
    // default connection
    public static $dbname = 'kryptofranc'; // Your database name
    public static $dbuser = 'thewolf'; // Your database username
    public static $dbpass = '#Akaklike666'; // // Your database password
    ...
    public static $sess_expire = 3000; // Specifies the lifetime of the session, as well as the existence of a key safety (for example, the maximum edit-saving timeout).
    ...
    public static $alt_encription_key = 'asdas8d98 98(*(*&(uyyjUUUIUNBK'; // needs to protect alt. session data, required if alt. session is enabled
    ...
    // editor
    public static $editor_url = '/lib/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
    ...
    public static $images_in_grid_height = 120; // maximal height of thumbnails in list view
    ...
    public static $safe_output = true; // encodes special characters to html-entities in grid view
    ...
    public static $upload_folder_def = '/img/products'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
	...
	public static $bool_field = "squaredFour"; // class for checkboxes
